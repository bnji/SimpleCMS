...
{
    public class CustomContentViewModel : ViewModelBase
    {
    ...
    public class CustomContentCreateOrEditViewModel : ViewModelBase
    {
        public int Id { get; set; }
        ...
        public CustomContentCreateOrEditViewModel()
        {
    ...
    [DataContract]
    public class BlogItemContentImagesViewModel : ViewModelBase
    {
        [DataMember]
        public int Index { get; set; }
        ...
        public BlogItemContentImagesViewModel()
        {
