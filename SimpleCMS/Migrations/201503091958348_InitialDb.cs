    ...
    public partial class InitialDb : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.ApplicationSettings", t => t.AppSettingsId)
                .ForeignKey("dbo.UserSettings", t => t.UserSettingsId)
                .Index(t => t.UserSettingsId)
                .Index(t => t.AppSettingsId)
        ...
        {
            DropForeignKey("dbo.AspNetUsers", "UserSettingsId", "dbo.UserSettings");
            ...
            DropIndex("dbo.AspNetUsers", new[] { "UserSettingsId" });
